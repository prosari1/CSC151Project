...
public class Policy2
{
	 ...
	 public Policy2(String policyNumber, String providerName, String holderFirstName, String holderLastName,	int holderAge,	String smokingStatus, double holderHeight, double holderWeight)
	 {
    ...
    /**
    * Alternative way of getting number of smokers
    * 
    */ 
    
	 // public int	getSmokingStatusNumber() 
// 	 {
//         if (smokingStatus.equalsIgnoreCase("smoker")) 
//         {
//             return 1;
...
// 	 }
//     
//     public int getNonSmokingStatusNumber()
//     {
